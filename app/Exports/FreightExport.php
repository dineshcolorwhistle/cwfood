...
use App\Models\{Freight,Client_company};
...
class FreightExport implements FromCollection,WithHeadings,WithStyles
{
    protected $headings;
    ...
    public function collection()
    {
        ...
        $collection = Freight::where('client_id', $clientID)->where('workspace_id', $workspaceID)->select($this->db_headings)->get();
