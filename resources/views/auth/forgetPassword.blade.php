...
<head>
    ...
    <title>Nutriflow - Forgot Password</title>
...
<body class="bg-gray-200">
                ...
                <div class="row signin-margin">
                    <div class="col-lg-5 col-md-8 col-12 mx-auto">
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            ...
                            <div class="card-body">
                                <form role="form" id="password_request" method="POST" action="{{ route('password.token.generate') }}"  class="text-start">
                                    @csrf
    ...
    <script>
        function form_signup(){
            $.ajax({
                url: $('form#password_request').attr('action'),
                method: $('form#password_request').attr('method'),
                data: $('form#password_request').serialize(),
