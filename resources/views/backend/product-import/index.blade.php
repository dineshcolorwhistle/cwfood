            ...
            <div class="">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <p>Download the Excel template and fill in your product data.</p>
                        <a href="{{ route('products.template.download') }}" class="btn btn-secondary-blue">
                            Download Template
                        </a>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <form id="uploadForm" enctype="multipart/form-data">
                            ...
                            <div class="ingredient-import-notes">
                                <h6>Note:</h6>
                                <ul>
                                    <li><strong>Product SKU:</strong> The unique identifier for each product.</li>
                    ...
                    <div id="previewSection" class="mb-4" style="display: none;">
                        ...
                        <form action="{{ route('products.upload') }}" method="POST" enctype="multipart/form-data" id="importForm">
                            @csrf
