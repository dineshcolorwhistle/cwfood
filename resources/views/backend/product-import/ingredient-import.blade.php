        ...
        <div class="col-md-12">
            <div class="">
                <div class="card-header">
                    <h1 class="page-title">Product Ingredients</h1>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    <div class="mb-4">
                        ...
                        <p>Download the Excel template and fill in your product ingredient data.</p>
                        <a href="{{ route('product.ingredinet.template.download') }}" class="btn btn-secondary-blue">
                            Download Template
                        </a>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <form id="uploadForm" enctype="multipart/form-data">
                            ...
                            <div class="ingredient-import-notes">
                                <h6>Note:</h6>
                                <ul>
                                    <li><strong>Product ID:</strong> The unique identifier for each product.</li>
                                    <li><strong>Ingredient SKU:</strong> The unique identifier for each ingredient.</li>
                                    <li><strong>New Record:</strong> If the ID & SKU doesn't exist, a <strong>new record</strong> will be created.</li>
                                </ul>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="previewSection" class="mb-4" style="display: none;">
                        ...
                        <form action="{{ route('products.ingredient.upload') }}" method="POST" enctype="multipart/form-data" id="importForm">
                            @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#previewBtn').click(function() {
            ...
            $.ajax({
                url: '{{ route("products.ingredient.preview") }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
