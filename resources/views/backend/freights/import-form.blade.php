        ...
        <div class="col-md-12">
            <div class="">
                <div class="card-header">
                    <h1 class="page-title">Freights</h1>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    <div class="mb-4">
                        ...
                        <p>Download the Excel template and fill in your freight data.</p>
                        <a href="{{ route('freight.template.download') }}" class="btn btn-secondary-blue">
                            Download Template
                        </a>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <form id="uploadForm" enctype="multipart/form-data">
                            ...
                            <div class="ingredient-import-notes">
                                <h6>Note:</h6>
                                <ul>
                                    <li><strong>Freight Name:</strong> The unique identifier for each freight.</li>
                    ...
                    <div id="previewSection" class="mb-4" style="display: none;">
                        ...
                        <form action="{{ route('freight.details.store') }}" method="POST" enctype="multipart/form-data" id="importForm">
                            @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#previewBtn').click(function() {
            ...
            $.ajax({
                url: '{{ route("freight.details.preview") }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
