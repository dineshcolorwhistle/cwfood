...
@else
    <div class="row g-4">
        ...
        @if($food->estimated_ingredients)
            <div class="col-12">
                @include('backend.fsanz_food.partials.cards._ingredients-card')
            </div>
        @endif
        ...
        @if($food->estimated_allergens)
            <div class="col-lg-6">
                @include('backend.fsanz_food.partials.cards._allergens-card')
            </div>
        @endif
        ...
        @if($food->estimated_dietary_status)
            <div class="col-lg-6">
                @include('backend.fsanz_food.partials.cards._dietary-status-card')
            </div>
        @endif

        {{-- Country of Origin --}}
        @if($food->estimated_origin)
            <div class="col-12">
                @include('backend.fsanz_food.partials.cards._country-of-origin-card')
            </div>
        @endif
    </div>
