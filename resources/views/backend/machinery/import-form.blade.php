            ...
            <div class="">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <p>Download the Excel template and fill in your machinery data.</p>
                        <a href="{{ route('machinery.template.download') }}" class="btn btn-secondary-blue">
                            Download Template
                        </a>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <form id="uploadForm" enctype="multipart/form-data">
                            ...
                            <div class="ingredient-import-notes">
                                <h6>Note:</h6>
                                <ul>
                                    <li><strong>Serial Number:</strong> The unique identifier for each machinery.</li>
                                    <li><strong>Update Existing:</strong> If the Serial Number exists, the record will be <strong>updated</strong> (overwritten).</li>
                                    <li><strong>New Record:</strong> If the Serial Number doesn't exist, a <strong>new record</strong> will be created.</li>
                                </ul>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="previewSection" class="mb-4" style="display: none;">
                        ...
                        <form action="{{ route('machinery.details.store') }}" method="POST" enctype="multipart/form-data" id="importForm">
                            @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#previewBtn').click(function() {
            ...
            $.ajax({
                url: '{{ route("machinery.details.preview") }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
