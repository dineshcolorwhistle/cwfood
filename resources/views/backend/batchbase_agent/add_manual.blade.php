                ...
                <div class="tab-pane fade show active" id="overview" role="tabpanel">
                    <div class="card p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <input type="hidden" name="spec_upload_type" value="0">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" class="form-control" name="nutr_dietary_fiber_g" id="nutr_dietary_fiber_g" placeholder="Dietary Fiber" value="{{ old('nutr_dietary_fiber_g', $specification->nutr_dietary_fiber_g ?? '') }}">
                            </div>
                            <div class="col-md-3">
