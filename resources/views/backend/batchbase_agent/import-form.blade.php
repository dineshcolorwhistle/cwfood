            ...
            <div class="">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <p>Download the Excel template and fill in your specification data.</p>
                        <a href="{{ route('specifications.template.download') }}" class="btn btn-secondary-blue">
                            Download Template
                        </a>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <form id="uploadForm" enctype="multipart/form-data">
                            ...
                            <div class="ingredient-import-notes">
                                <h6>Note:</h6>
                                <ul>
                                    <li><strong>Specification Name:</strong> The unique identifier for each specification.</li>
                                    <li><strong>Update Existing:</strong> If the Name exists, the record will be <strong>updated</strong> (overwritten).</li>
                                    <li><strong>New Record:</strong> If the Name doesn't exist, a <strong>new record</strong> will be created.</li>
                                </ul>
                            </div>
                        </form>
                    </div>
                    ...
                    <div id="previewSection" class="mb-4" style="display: none;">
                        ...
                        <form action="{{ route('specifications.details.store') }}" method="POST" enctype="multipart/form-data" id="importForm">
                            @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#previewBtn').click(function() {
            ...
            $.ajax({
                url: '{{ route("specifications.details.preview") }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
