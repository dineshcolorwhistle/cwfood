...
'pageTitle' => 'Raw Materials View',
'activeMenu' => [
'item' => 'Raw Materials View',
'subitem' => 'Raw Materials View',
'additional' => '',
],
'features' => [
'datatables' => '1',
...
<div class="container-fluid product-search dataTable-wrapper">
    <div class="card-header">
        <div class="title-add">
            <h1 class="page-title">Raw Materials View</h1>
    ...
    <div class="card-body">
        <div id="resultsContainer" class="background-bg">
            @include('backend.product-views.partials.rawmaterial-view', ['lists' => $lists])
        </div>
...
<script>
    $(document).ready(function() {
        ...
        // Initialize all tooltips first (if not already)
        ...
        // Handle hiding tooltips when mouse leaves a card
        document.querySelectorAll('.grid-view').forEach(function(card) {
    ...
    function performSearch(searchTerm) {
        ...
        $.ajax({
            url: "{{ route('rawmaterials-view.search') }}",
            method: 'GET',
            data: {
                search: searchTerm,
                perPage: $('#perPage').val(),
