    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-12">
            <div class="button-row grid-btn">
                <a href="{{ route('products.edit', ['product' => $product->id, 'step' => 4]) }}"class="btn btn-secondary-blue mb-0 me-1 js-btn-previous" title="Previous">Back</a>
                <button class="btn btn-secondary-blue mb-0 js-btn-save" type="button" title="Save">Save</button>
                <button class="btn btn-secondary-blue mb-0 js-btn-next" type="button" title="Finish">Finish</button>
            </div>
            <div class="mt-4">
