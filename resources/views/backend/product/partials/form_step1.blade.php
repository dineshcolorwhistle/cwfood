    ...
    <div class="row mt-3">
        <div class="col-lg-5 col-md-5 col-sm-12 col-12 mt-4 mt-sm-0">
            ...
            <table class="table table-borderless units-price">
                ...
                <!-- RRP (AUD) Section -->
                <!-- <tr>
                    <td class="align-middle text-dark-mud-ss">RRP (excl GST)</td>
                    <td>
                        <div class="input-group input-group-dynamic table-input-readonly">
                            <input type="text" name="price_ind_unit" id="price_ind_unit" class="form-control ph-blue" placeholder="0" readonly>
                        </div>
                    </td>
                    <td>
                        <div class="input-group input-group-dynamic table-active-input">
                            <input type="text" name="price_retail_unit" id="price_retail_unit" step="1" min="0" class="form-control unit_weight_input ph-blue @error('price_retail_unit') is-invalid @enderror" value="{{ old('price_retail_unit', round($product->price_retail_unit,2)) }}" placeholder="0">
                            @error('price_retail_unit')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    </td>
                    <td>
                        <div class="input-group input-group-dynamic table-input-readonly">
                            <input type="text" name="price_carton" id="price_carton" class="form-control ph-blue" placeholder="0" readonly>
                        </div>
                    </td>
                    <td>
                        <div class="input-group input-group-dynamic table-input-readonly">
                            <input type="text" name="price_pallet" id="price_pallet" class="form-control ph-blue" placeholder="0" readonly>
                        </div>
                    </td>
                </tr> -->
            </table>

            <!-- <div class="input-group input-group-dynamic mt-4 mb-4">
                <label class="form-label">Contingency</label>
                <div class="d-flex align-items-center gap-2">
                    <input type="text" name="contingency" id="contingency" value="{{ old('contingency', $product->contingency ?? '') }}" class="form-control" placeholder="Type Contingency">
                    <p class="m-0">%</p>
                </div>
            </div> -->
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-12 mt-4 mt-sm-0">
            <div class="button-row d-flex">
                <button class="btn btn-secondary-blue mb-0 js-btn-save" type="button" title="Save">Save</button>
