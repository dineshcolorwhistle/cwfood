...
<style>
    ...
    .product_specs .title-add h1 { color: var(--secondary-color); font-size: 32px; font-weight: 400; line-height: normal; }
</style>
@endpush
@section('content')
    ...
    <div class="product_specs_content">
        <div class="card-header">
            <div class="top_title_wrapper d-flex justify-content-between align-items-center mb-3 hidden">
                ...
                <div class="button-row">  
                    ...
                    <button type="button" class="btn btn-primary-orange plus-icon me-3" id="pdf_download" title="Download Spec Sheet">
        ...
        <div class="row card-body pt-1">
            ...
            <div class="col-lg-5 col-md-5">
                ...
                <x-units-price-table :product="$product" />
            </div>
        ...
        <div class="product_details_footer card-footer mb-4">
        </div>
    </div>
</div>
@endsection
    ...
    $(document).on('click','#pdf_download',function(){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ route('products.download_specs', [$product->id, 'black']) }}";
            } else if (result.dismiss === Swal.DismissReason.cancel) {
                // Handle Custom Color download
                window.location.href = "{{ route('products.download_specs', [$product->id, 'custom']) }}";
            }
        });
    });
