...
<html>
    ...
    <head>
        ...
        <style>
            ...
            h1, h2, h3, h4,h5{font-family: "Montserrat", Arial, sans-serif;font-weight: 700;font-style: normal;line-height: normal;}
            ...
            h3,h5{font-size: 17px; color: var(--secondary-color); margin-bottom:3px;}
            ...
            .rawmaterial-costing-wrapper,.pdf-second-page{clear: both;margin-top:5px;}
            ...
            .costing_table {width: 100%;border-collapse: collapse;font-family: 'Montserrat', Arial, sans-serif;font-size: 11px;color: #333;}
            .costing_table th,.costing_table td,.footer-table th,.footer-table td {padding: 5px 7px;text-align: left;}
            .costing_table thead th,.footer-table thead th {border-bottom: 1px solid #ccc;font-weight: bold;}
            .costing_table tbody td, .footer-table tbody td{border-bottom: 1px solid #e0e0e0;}
            ...
            p.prod_sku, span.prod_sku{color:var(--primary-color);font-weight: 700;}
    ...
    <body>
        ...
        <main>
            ...
            <div class="rawmaterial-costing-wrapper">
                <div class="advance-modelling">
                    {!! $rawmaterial_cost_html !!}
                </div>
            </div>
            ...
            <div class="pdf-second-page" style="margin-top:-50px;">
                <div class="product-secondpage">
                    <h3>{{ $product->prod_name }}</h3>  
                    <p class="prod_sku">{{ $product->prod_sku }}</p>
                </div>
                {!! $direct_cost_html !!}
